<%-- 
    Document   : cadastro
    Created on : 27/10/2016, 19:57:42
    Author     : sOn
--%>
...
<html>
 ...
 <h1> DADOS CADASTRAIS</h1> 
  <h2> Preencha o formulário abaixo</h2><br></br>
...
<fieldset>
 ...
 <table cellspacing="7">
  ...
  <tr>
   ...
   <td>
       <input type="date" name="dataNasc" size="10" value=""/> 
   </td>
  </tr>
  ...
  <tr>
   ...
   <td align="left">
    <input type="text" name="rg" size="10" maxlength="10"/> 
   </td>
   <td>
       <label for="telRes">Tel Residencial:</label>
   </td>
   <td align="left">
       <input type="text" name="telRes" size="10" maxlength="10"/>          
   </td> 
  </tr>
  ...
  <tr>
   ...
   <td align="left">
    <input type="text" name="cpf" size="10" maxlength="10"/> 
   </td>
    <td>
       <label for="telCel">Tel Celular:</label>
   </td>
   <td align="left">
       <input type="text" name="telCel" size="10" maxlength="10"/>          
   </td> 
  </tr>
  </tr>
 </table>
...
<fieldset>
 ...
 <table cellspacing="10">
  ...
  <tr>
   ...
   <td align="left">
       <input type="text" name="bairro" size="35">
   </td>
  </tr>
  <tr>
   <td>
...
<fieldset>
    ...
    <tr>
        <td>
            Cargo:&emsp; <input type="text" name="cargo" value="" size="20"/>
        </td>
    </tr>
            
</fieldset>
<br />
<input type="submit"  value="Enviar" name="funcionario">
